...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_PROVIDER: string;  // 'claude' | 'gemini' | 'openrouter' | 'lmstudio'
...
export class SettingsDefaultsManager {
  ...
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    // LM Studio Configuration
    CLAUDE_MEM_LMSTUDIO_BASE_URL: 'http://localhost:1234/v1',  // Default LM Studio server URL
    CLAUDE_MEM_LMSTUDIO_MODEL: '',  // Empty = use whatever model is loaded
    // System Configuration

    ...
    fetch(API_ENDPOINTS.SETTINGS)
      ...
      .then(data => {
        setSettings({
          ...
          CLAUDE_MEM_LMSTUDIO_BASE_URL: data.CLAUDE_MEM_LMSTUDIO_BASE_URL || DEFAULT_SETTINGS.CLAUDE_MEM_LMSTUDIO_BASE_URL,
          CLAUDE_MEM_LMSTUDIO_MODEL: data.CLAUDE_MEM_LMSTUDIO_MODEL || DEFAULT_SETTINGS.CLAUDE_MEM_LMSTUDIO_MODEL,
